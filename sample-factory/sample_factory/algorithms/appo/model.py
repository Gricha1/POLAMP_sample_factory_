...
#custom add
from sample_factory.algorithms.appo.custom_dist_utils import apply_squashing_func
...
class _ActorCriticSharedWeights(_ActorCriticBase):
    ...
    def forward_tail(self, core_output, with_action_distribution=False):
        ...
        #custom add
        #action_distribution_params, actions, log_prob_actions = \
        #    apply_squashing_func(action_distribution_params, actions, log_prob_actions) 
...
def create_actor_critic(cfg, obs_space, action_space, timing=None):
    ...
    def make_core(encoder):
        #print("DEBUG make core:", encoder.get_encoder_out_size())
