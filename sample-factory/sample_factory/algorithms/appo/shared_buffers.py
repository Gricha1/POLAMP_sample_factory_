...
class TensorDict(dict):
    ...
    def set_data_func(self, x, index, new_data):
        #print("DEBUG new data:", new_data['obs']['obs'].keys())
        #print("DEBUG new data:", type(new_data['obs']))
        if isinstance(new_data, (dict, TensorDict)):
            #print("DEBUG obs:", new_data.keys())
            for new_data_key, new_data_value in new_data.items():
                #print("DEBUG data:", type(x), type(new_data_key))
